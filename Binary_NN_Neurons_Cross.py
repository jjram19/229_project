...
x_data = x_data_total[total_dev_size:]
y_data = y_data_total[total_dev_size:]
neurons = [1000, 250, 100]
dev_ind = 0
for n_hidden_1 in neurons:
	x_dev = x_data_total[dev_ind:dev_ind+dev_size];
	y_dev = y_data_total[dev_ind:dev_ind+dev_size];
	dev_ind += 100
	...
	with tf.Session() as sess:
		...
		print("Cost vs Epoch: ", epoch_cost)
